...
#         print (self.net)
    ...
    def predict_classes(self, dataset, batch_size=16, verbose=1,clear_method=lambda x:x.detach().cpu().numpy()):
        ...
        # dataset = deephunter_util.batch_data(dataset) syyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
        ...
        # print ("logits", torch.is_tensor(logits_out), type(logits_out))
        #
        # print (logits_out.shape,"logits.shape",)
...
if __name__=="__main__":
    ...
    #
    # print (type(cls_ret))
    cls_trace = tempmodel.predict_v2(dataset)
