...
def get_layer_output_batch(model, data, layer_name=None,fetch_func= lambda x:x[0],**kwargs ):   
    ...
    dataloader = Data.DataLoader(dataset=data, batch_size=128, shuffle=False)
    
    # dataloader  = batch_data(data) syyyyyyyyyyyyyyyyyy
...
def get_layer_output_batch_withreduce(model, data, layer_name=None,fetch_func= lambda x:x[0],**kwargs ):   
    ...
    # dataloader  = batch_data(data)###syyyyyyyyyyyyy
...
def extract_outputs_batch(model, data, module, force_relu=True,
    ...
    # dataloader  = batch_data(data) syyyyyyyyyyyyyyyyyyyyyyyyy
...
def predict_batch(model, data, fetch_func= lambda x:x[0],**kwargs ):
    ...
    #                                transform=transforms.ToTensor(), download=True,split="train")
    dataloader = Data.DataLoader(dataset=data, batch_size=64, shuffle=False)
    collect_list1 = []
    # dataloader = batch_data(data)  syyyyyyyyyyyyyyyyyyyyyyy
